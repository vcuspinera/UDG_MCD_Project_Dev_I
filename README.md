...
|10| 2023-03-22|<ul><li>Calificaciones proyecto EDA</li></ul>|<ul><li>Pres. 07, librería `snscrape`</li><li>Compartir observaciones de proyectos de EDA</li><li>[Revisión de calificaciones proy. EDA](https://github.com/vcuspinera/UDG_MCD_Project_Dev_II/tree/main/grades#proyecto-de-análisis-eda)</li><li>[Act. 17 • Consulta de tweets](https://github.com/vcuspinera/UDG_MCD_Project_Dev_II/blob/main/actividades/17_Consultar_tweets.ipynb)</li></lu>|P.D.|
