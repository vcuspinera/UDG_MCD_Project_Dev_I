...
|10| 2023-03-22|<ul><li>Calificaciones proyecto EDA</li></ul>|<ul><li>Pres. 07, librería `snscrape`</li><li>Compartir observaciones de proyectos de EDA</li><li>Revisión de calificaciones proy. EDA</li><li>Quiz 07</li></lu>|P.D.|
|11| 2023-03-29|<ul><li>Análisis de texto</li></ul>|<ul><li>Pres. 08, librería `spaCy`</li><li>[Act. 17 • Consulta de tweets](https://github.com/vcuspinera/UDG_MCD_Project_Dev_II/blob/main/actividades/17_Consultar_tweets.ipynb)</li><li>[Act. 18 • Herramientas de texto](https://github.com/vcuspinera/UDG_MCD_Project_Dev_II/blob/main/actividades/18_Text_tools.ipynb)</li><li>[Act. 19 • Análisis de texto](https://github.com/vcuspinera/UDG_MCD_Project_Dev_II/blob/main/actividades/19_Text_analysis.ipynb)</li><li>Quiz 08</li></lu>|P.D.|
|12| 2023-04-05|N/A|**No habrá clase**|N/A|
|13| 2023-04-12|N/A|**No habrá clase**|N/A|
|14| 2023-04-19|<ul><li>Mapas en Python</li></ul>|<ul><li>Charla con un invitado (*activ. por confirmar*).</li><li>Pres. 09, librería `GeoPandas`</li><li>Act. 20 • Spatial Data in Python</li><li>Quiz 09</li></lu>|P.D.|
|15| 2023-04-26|<ul><li>Asignación proyecto final</li></ul> |<ul><li>Pres. 10, librería `Scikit-learn`</li><li>Asignación de equipos para proyecto final</li><li>[Guía para proyecto final](https://github.com/vcuspinera/UDG_MCD_Project_Dev_II/tree/main/proyectos/final)</li><li>Quiz 10</li></ul>|P.D.|
|16| 2023-05-03|<ul><li>Seguimiento proyecto final</li></ul>|</li><li>Espacio para dudas sobre el proyecto final</li><ul>|P.D.|
|17| 2023-05-10|<ul><li>Cierre de curso</li></ul>|<ul><li>Charla con un invitado (*activ. por confirmar*).</li><li>Compartir observaciones de proyecto final</li><li>Revisión de actividades para puntos extras</li><li>Calificaciones acumuladas</li><li>Encuesta final del curso</li><ul>|P.D.|
