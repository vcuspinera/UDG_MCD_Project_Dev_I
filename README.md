...
|10| 2023-03-22|<ul><li>Calificaciones proyecto EDA</li><li>Consultas en Twitter con Python</li></ul>|<ul><li>Pres. 07, librería `snscrape`</li><li>[Act. 17 • Consulta de tweets](https://github.com/vcuspinera/UDG_MCD_Project_Dev_II/blob/main/actividades/17_Consultar_tweets.ipynb)</li><li>Compartir observaciones de proyectos de EDA</li><li>[Revisión de calificaciones proy. EDA](https://github.com/vcuspinera/UDG_MCD_Project_Dev_II/tree/main/grades#proyecto-de-análisis-eda)</li></lu>|[Ver Issue #65](https://github.com/vcuspinera/UDG_MCD_Project_Dev_II/issues/65)|
|11| 2023-03-29|<ul><li>Análisis de texto</li></ul>|<ul><li>Pres. 08, librería `spaCy`</li><li>[Act. 18 • Herramientas de texto](https://github.com/vcuspinera/UDG_MCD_Project_Dev_II/blob/main/actividades/18_Text_tools.ipynb)</li><li>[Act. 19 • Análisis de texto](https://github.com/vcuspinera/UDG_MCD_Project_Dev_II/blob/main/actividades/19_Text_analysis.ipynb)</li></lu>|P.D.|
|12| 2023-04-05|N/A|**No habrá clase**|N/A|
|13| 2023-04-12|N/A|**No habrá clase**|N/A|
|14| 2023-04-19|<ul><li>Mapas en Python</li></ul>|<ul><li>Charla con un invitado (*activ. por confirmar*).</li><li>Pres. 09, librería `GeoPandas`</li><li>Act. 20 • Spatial Data in Python</li></lu>|P.D.|
|15| 2023-04-26|<ul><li>Asignación proyecto final</li></ul> |<ul><li>Pres. 10, librería `Scikit-learn`</li><li>Asignación de equipos para proyecto final</li><li>[Guía para proyecto final](https://github.com/vcuspinera/UDG_MCD_Project_Dev_II/tree/main/proyectos/final)</li></ul>|P.D.|
