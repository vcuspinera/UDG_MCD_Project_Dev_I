...
|14| 2023-04-19|<ul><li>Mapas en Python</li><li>Asignación proyecto final</li></ul>|<ul><li>Charla con un invitado (*activ. por confirmar*).</li><li>Pres. 09, [librería `GeoPandas`](https://geopandas.org/en/stable/)</li><li>[Asignación de equipos para proyecto final](https://github.com/vcuspinera/UDG_MCD_Project_Dev_II/blob/main/actividades/src/asignar_proy_final.ipynb)</li><li>[Guía para proyecto final](https://github.com/vcuspinera/UDG_MCD_Project_Dev_II/tree/main/proyectos/final)</li></lu>|[Ver Issue #68](https://github.com/vcuspinera/UDG_MCD_Project_Dev_II/issues/68)|
