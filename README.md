...
|5| 2022-09-14| Planeación del riesgo |<ul><li>Presentación cap. 4, libro PMI-RMP</li><li>[Activ. 08, Práctica con Git y GitHub](https://github.com/vcuspinera/UDG_MCD_Project_Dev_II/blob/main/actividades/08_Git_and_GitHub.md)</li><li>Quiz 04, cap. 4 del libro PMI-RMP</li></ul> |P.D. |
